...
async function cleanup() {
  const targetTasks = [
    ...
    { title: "Find Remote Jobs & Lead Gen", status: "completed", priority: 3, description: "Identified 5 shop leads and 5 Senior AI/Ops roles in memory/leads-research.md." },
    { title: "Setup Sales Bot Agent", status: "completed", priority: 3, description: "Successfully deployed Sales Bot research v2 sub-agent." },
    { title: "Vercel Deployment Audit", status: "completed", priority: 2, description: "Build verified passing; identified missing Stripe/OpenClaw secrets." },
