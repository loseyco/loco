    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <header className="relative overflow-hidden">
        ...
        <nav className="relative z-10 flex items-center justify-between px-6 py-6 max-w-6xl mx-auto">
          <div className="text-2xl font-bold text-white tracking-tight">
            Losey<span className="text-blue-400">.Co</span>
          </div>
          <div className="flex items-center gap-6">
            <Link href="https://gridpass.app" className="text-slate-300 hover:text-white transition-colors text-sm font-medium">
              GridPass
            </Link>
            <Link href="https://pjlosey.com" className="text-slate-300 hover:text-white transition-colors text-sm font-medium">
              Resume
            </Link>
            <Link href="mailto:pj@losey.co" className="bg-blue-600 hover:bg-blue-500 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors">
              Contact
            </Link>
          </div>
        </nav>
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 pt-20 pb-32">
          <div className="max-w-3xl">
            ...
            <div className="flex flex-wrap gap-4">
              <Link href="mailto:pj@losey.co" className="bg-white text-slate-900 hover:bg-slate-100 px-6 py-3 rounded-lg font-semibold transition-colors inline-flex items-center gap-2">
                Get in Touch
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3" />
                </svg>
              </Link>
              <Link href="https://gridpass.app" className="border border-slate-600 text-white hover:border-slate-500 hover:bg-slate-800/50 px-6 py-3 rounded-lg font-semibold transition-colors">
                View GridPass
              </Link>
            </div>
          </div>
      ...
      <section className="py-24 px-6 border-t border-slate-800">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="bg-gradient-to-r from-blue-900/40 to-cyan-900/40 border border-blue-500/20 rounded-2xl p-8 md:p-12">
            <div className="flex flex-col md:flex-row gap-8 items-center">
              <div className="flex-1">
                <div className="text-blue-400 font-semibold mb-2">GridPass.app</div>
                ...
                <Link href="https://gridpass.app" className="inline-flex items-center gap-2 text-blue-400 hover:text-blue-300 font-medium transition-colors">
                  Visit GridPass
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <div className="w-full md:w-80 h-48 bg-gradient-to-br from-slate-700 to-slate-800 rounded-xl flex items-center justify-center">
